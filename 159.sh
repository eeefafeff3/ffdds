...
# 生成随机 IP 地址（在 172.16.0.0/12 私有范围内）
RANDOM_OCTET1=$((RANDOM % 16 + 16))  # 16-31
RANDOM_OCTET2=$((RANDOM % 256))      # 0-255
IP_VETH0="172.$RANDOM_OCTET1.$RANDOM_OCTET2.1"
IP_VETH1="172.$RANDOM_OCTET1.$RANDOM_OCTET2.2"
...
# 配置 NAT
log "配置 NAT 规则"
iptables -t nat -A POSTROUTING -s "172.$RANDOM_OCTET1.$RANDOM_OCTET2.0/24" -o "$MAIN_IFACE" -j MASQUERADE || { log "配置 NAT 失败"; exit 1; }
